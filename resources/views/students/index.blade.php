...
<div id="searchForm" class="form-style float-right " >
    ...
    <form method="post" action="{{ route('students.search') }}">
        ...
        <input type="text" height="100px" width="100px" id="search_roll_no" name="search_roll_no" placeholder="search by roll_no or name " class="p-2"  required>
...
<div class="table-container table-striped table-hover">
    <h2 class="text-info p-3">Student Records</h2>
