...
<form action="{{ route('students.search') }}" method="POST" class="form-inline mb-3 float-right">
    ...
    <button type="submit" class="btn btn-success"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" class="bi bi-search " viewBox="0 0 16 16">
        <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001q.044.06.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1 1 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0"/>
      </svg></button>
    </form> 

{{-- <br/><br/> <br/> --}}
<a href="{{ route('students.create') }}" class="btn btn-primary mb-3 float-left"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-person-add" viewBox="0 0 16 16">
            ...
            <tr>
                ...
                <td class="actions">
                    ...
                    <a href="{{ route('students.marks.index', $student->id) }}" >
                        <button class="btn btn-info d-inline-block m-2" onmouseover="this.nextElementSibling.style.display='block'">View Marks</button>
                    
                    </a>
                    <div style="display: none; position: absolute; bottom: 100%; left: 50%; transform: translateX(-50%); background-color: black; color: white; padding: 5px; border-radius: 5px; white-space: nowrap;">
